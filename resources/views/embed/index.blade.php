...
@section('title', 'Embed Builder - SantuyTL')

@section('content')
<div class="page-header">
    <h1 class="page-title"><i class="fa-solid fa-code"></i> Embed Builder</h1>
    <p class="page-subtitle">Buat dan kirim pesan embed ke channel Discord</p>
</div>

<form action="{{ route('embed.send', ['guildId' => request()->route('guildId')]) }}" method="POST" id="embedForm">
    @csrf
    <div class="embed-grid">
        ...
        <div class="editor-panel">
            ...
            <div class="ios-card">
                ...
                <div class="ios-list">
                    <div class="ios-list-item">
                        <textarea name="content" id="plainContent" class="form-textarea" 
                                  placeholder="Pesan teks biasa di luar embed..."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="ios-card">
                ...
                <div class="ios-list">
                    <div class="ios-list-item column">
                        ...
                        <input type="text" name="title" id="embedTitle" class="form-input" 
                               placeholder="Embed Title" maxlength="256">
                    </div>
                    <div class="ios-list-item column">
                        <label class="form-label">Description</label>
                        <textarea name="description" id="embedDesc" class="form-textarea" 
                                  placeholder="Embed description... (supports **bold**, *italic*, `code`)"></textarea>
                    </div>
                    <div class="ios-list-item">
                        <label class="form-label">Embed Color</label>
                        <div class="color-picker-wrapper">
                            <input type="color" name="color" id="colorPicker" value="#6c63ff">
                            <span class="color-hex" id="colorHex">#6c63ff</span>
                            <div class="color-presets">
                                ...
                                <button type="button" class="preset" style="background:#eb459e" data-color="#eb459e"></button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="ios-card">
                ...
                <div class="ios-list">
                    <div class="ios-list-item column">
                        ...
                        <input type="text" name="author_name" id="authorName" class="form-input" placeholder="Author name">
                    </div>
                    <div class="ios-list-item column">
                        <label class="form-label">Author Icon URL</label>
                        <input type="url" name="author_icon" id="authorIcon" class="form-input" placeholder="https://example.com/icon.png">
                    </div>
                </div>
            </div>
            ...
            <div class="ios-card">
                ...
                <div class="ios-list">
                    <div class="ios-list-item column">
                        ...
                        <input type="url" name="thumbnail" id="thumbnailUrl" class="form-input" placeholder="https://example.com/thumbnail.png">
                    </div>
                    <div class="ios-list-item column">
                        <label class="form-label">Image URL (besar, di bawah)</label>
                        <input type="url" name="image" id="imageUrl" class="form-input" placeholder="https://example.com/image.png">
                    </div>
                </div>
            </div>
            ...
            <div class="ios-card">
                ...
                <div class="ios-list">
                    <div class="ios-list-item column">
                        ...
                        <input type="text" name="footer_text" id="footerText" class="form-input" placeholder="Footer text">
                    </div>
                    <div class="ios-list-item">
