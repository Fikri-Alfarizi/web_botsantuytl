...
class YoutubeAlertsController extends Controller
{
    public function index()
    {
        ...
        $alerts = DB::table('social_alerts')->where('guild_id', $guildId)->where('platform', 'youtube')->get();
        ...
        return view('social.youtube.index', compact('alerts', 'channels'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::table('social_alerts')->insert([
            ...
            'message' => $request->message ?? "New video from {identifier}: {link}",
            'created_at' => now(), 'updated_at' => now(),
        ]);

        return redirect()->back()->with('success', 'YouTube Alert created.');
    }
