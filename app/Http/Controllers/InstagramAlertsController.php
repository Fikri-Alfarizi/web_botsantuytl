...
class InstagramAlertsController extends Controller
{
    public function index()
    {
        ...
        $alerts = DB::table('social_alerts')->where('guild_id', $guildId)->where('platform', 'instagram')->get();
        ...
        return view('social.instagram.index', compact('alerts', 'channels'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::table('social_alerts')->insert([
            ...
            'message' => $request->message ?? "New post from {identifier}: {link}",
            'created_at' => now(), 'updated_at' => now(),
        ]);

        return redirect()->back()->with('success', 'Instagram Alert created.');
    }
