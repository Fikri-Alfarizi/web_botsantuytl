...
class TiktokAlertsController extends Controller
{
    public function index()
    {
        ...
        $alerts = DB::table('social_alerts')->where('guild_id', $guildId)->where('platform', 'tiktok')->get();
        ...
        return view('social.tiktok.index', compact('alerts', 'channels'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::table('social_alerts')->insert([
            ...
            'message' => $request->message ?? "New TikTok! {link}",
            'created_at' => now(), 'updated_at' => now(),
        ]);

        return redirect()->back()->with('success', 'TikTok Alert created.');
    }
