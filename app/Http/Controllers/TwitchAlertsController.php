...
class TwitchAlertsController extends Controller
{
    public function index()
    {
        ...
        return view('social.twitch.index', compact('alerts', 'channels'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::table('social_alerts')->insert([
            ...
            'message' => $request->message ?? "Hey everyone! {identifier} is live on Twitch! {link}",
            'created_at' => now(),
            'updated_at' => now(),
        ]);

        return redirect()->back()->with('success', 'Twitch Alert created.');
    }
