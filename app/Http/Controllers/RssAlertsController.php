...
class RssAlertsController extends Controller
{
    public function index()
    {
        ...
        return view('social.rss.index', compact('alerts', 'channels'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::table('social_alerts')->insert([
            ...
            'message' => $request->message ?? "New post: {link}",
            'created_at' => now(),
            'updated_at' => now(),
        ]);

        return redirect()->back()->with('success', 'RSS Feed Alert created.');
    }
